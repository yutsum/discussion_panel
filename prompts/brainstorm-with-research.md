...
Save it to `brainstorms/<topic-slug>/analyst/brief.md`.
If the debate later turns on brand assets or brand identity, refresh the shared brief again before continuing.
